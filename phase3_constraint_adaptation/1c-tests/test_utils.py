...
def random_pop(n, boardsize, instance=binaryGenotype):
	return instance.initialization(n, length=boardsize)
...
def all_ones(boardsize, instance=binaryGenotype):
	ret = instance()
	ret.gene = [1 for _ in range(boardsize)]
	return ret

def all_zeroes(boardsize, instance=binaryGenotype):
	ret = instance()
